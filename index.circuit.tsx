...
export const BluetoothPedometer = () => (
  ...
  >
    ...
    <capacitor name="C4" capacitance="4.7uF" maxVoltageRating="10V" footprint="cap0603" manufacturerPartNumber="CL10A475KP8NNNC" supplierPartNumbers={{ jlcpcb: ["C1705"] }} schSheetName="power" pcbX={-5.3} pcbY={4.4} pcbRotation={270} schX={6.5} schY={5.5} schOrientation="vertical" connections={{ pin1: "net.PMIC_VDD_1V8", pin2: "net.GND" }} />
    <capacitor name="C3" capacitance="1uF" maxVoltageRating="25V" footprint="cap0402" manufacturerPartNumber="CL05A105KA5NQNC" supplierPartNumbers={{ jlcpcb: ["C52923"] }} schSheetName="power" pcbX={-9.5} pcbY={7.5} pcbRotation={180} schX={8.5} schY={5.5} schOrientation="vertical" connections={{ pin1: "net.VBAT_SYS", pin2: "net.GND" }} />
    <capacitor name="C2" capacitance="10uF" maxVoltageRating="6.3V" footprint="cap0603" manufacturerPartNumber="CL10A106MQ8NNNC" supplierPartNumbers={{ jlcpcb: ["C1691"] }} schSheetName="power" pcbX={-9.6} pcbY={9.8} pcbRotation={180} schX={10.5} schY={5.5} schOrientation="vertical" connections={{ pin1: "net.SYS_RAW", pin2: "net.GND" }} />
    <capacitor name="C5" capacitance="4.7uF" maxVoltageRating="10V" footprint="cap0603" manufacturerPartNumber="CL10A475KP8NNNC" supplierPartNumbers={{ jlcpcb: ["C1705"] }} schSheetName="power" pcbX={-2.6} pcbY={10.4} pcbRotation={0} schX={12.5} schY={5.5} schOrientation="vertical" connections={{ pin1: "net.SYS_RAW", pin2: "net.GND" }} />
    <capacitor name="C6" capacitance="2.2uF" maxVoltageRating="6.3V" footprint="cap0402" manufacturerPartNumber="CL05A225MQ5NSNC" supplierPartNumbers={{ jlcpcb: ["C12530"] }} schSheetName="power" pcbX={-5.4} pcbY={11.6} pcbRotation={90} schX={8.5} schY={2.8} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />

    <resistor name="R3" resistance="1.2k" tolerance="1%" footprint="res0402" manufacturerPartNumber="FRC0402F1201TS" supplierPartNumbers={{ jlcpcb: ["C2909307"] }} schSheetName="power" pcbX={-7.4} pcbY={12.1} pcbRotation={90} schX={0} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.PMIC_IMAX", pin2: "net.GND" }} />
    <resistor name="R4" resistance="10k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1002TCE" supplierPartNumbers={{ jlcpcb: ["C25744"] }} schSheetName="power" pcbX={-9.4} pcbY={12.4} pcbRotation={0} schX={2} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.BAT_NTC", pin2: "net.GND" }} />
    <resistor name="R5" resistance="100k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1003TCE" supplierPartNumbers={{ jlcpcb: ["C25741"] }} schSheetName="power" pcbX={-7.4} pcbY={3.5} pcbRotation={0} schX={4} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.PMIC_CE", pin2: "net.VCORE" }} />
    <resistor name="R6" resistance="100k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1003TCE" supplierPartNumbers={{ jlcpcb: ["C25741"] }} schSheetName="power" pcbX={-2.4} pcbY={6.2} pcbRotation={0} schX={6} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.PMIC_INT", pin2: "net.VCORE" }} />
    <resistor name="R7" resistance="100k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1003TCE" supplierPartNumbers={{ jlcpcb: ["C25741"] }} schSheetName="power" pcbX={-2.4} pcbY={4.2} pcbRotation={0} schX={7.8} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.PMIC_PG", pin2: "net.VCORE" }} />

    {/* Battery & Service connectors */}
    <B3B_PH_K_S_LF__SN_
      name="J2"
      schSheetName="power"
      pcbX={-18}
    ...
    <resistor name="R11" resistance="10k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1002TCE" supplierPartNumbers={{ jlcpcb: ["C25744"] }} schSheetName="power" pcbX={1} pcbY={0.2} pcbRotation={0} schX={11} schY={-5} schOrientation="vertical" connections={{ pin1: "net.I2C_SCL", pin2: "net.VCORE" }} />
    ...
    <capacitor name="C11" capacitance="1uF" maxVoltageRating="25V" footprint="cap0402" manufacturerPartNumber="CL05A105KA5NQNC" supplierPartNumbers={{ jlcpcb: ["C52923"] }} schSheetName="mcu" pcbX={13.200000} pcbY={3.2} pcbRotation={0} schX={13.5} schY={6.5} schOrientation="vertical" connections={{ pin1: "net.VDDD", pin2: "net.GND" }} />

    {/* VCORE Decoupling */}
    <capacitor name="C12" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="mcu" pcbX={15.900000} pcbY={4.2} pcbRotation={0} schX={5.5} schY={3.5} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />
    <capacitor name="C13" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="mcu" pcbX={13.700000} pcbY={4.7} pcbRotation={0} schX={7.5} schY={3.5} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />
    <capacitor name="C14" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="mcu" pcbX={5.300000} pcbRotation={180} pcbY={5.1} schX={9.5} schY={3.5} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />
    <capacitor name="C15" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="mcu" pcbX={8.500000} pcbY={11.3} pcbRotation={90} schX={11.5} schY={3.5} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />

    {/* Reset and Debug Block */}
    <resistor name="R12" resistance="100k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1003TCE" supplierPartNumbers={{ jlcpcb: ["C25741"] }} schSheetName="mcu" pcbX={6.200000} pcbRotation={180} pcbY={2.5} schX={-10.5} schY={-4} schOrientation="vertical" connections={{ pin1: "net.MCU_RSTN", pin2: "net.VCORE" }} />
    <capacitor name="C17" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="mcu" pcbX={5.700000} pcbRotation={180} pcbY={0.6} schX={-8.5} schY={-4} schOrientation="vertical" connections={{ pin1: "net.MCU_RSTN", pin2: "net.GND" }} />
    <PZ200V_11_05P
      name="J4"
      schSheetName="mcu"
      pcbX={0}
    ...
    />
    <capacitor name="C18" capacitance="12pF" maxVoltageRating="50V" footprint="cap0402" manufacturerPartNumber="0402CG120J500NT" supplierPartNumbers={{ jlcpcb: ["C1547"] }} schSheetName="mcu" pcbRotation={270} pcbX={8.100000} pcbY={-0.2} schX={8} schY={-3.8} schOrientation="vertical" connections={{ pin1: "net.X32_P", pin2: "net.GND" }} />
    <capacitor name="C19" capacitance="15pF" maxVoltageRating="50V" footprint="cap0402" manufacturerPartNumber="0402CG150J500NT" supplierPartNumbers={{ jlcpcb: ["C1548"] }} schSheetName="mcu" pcbRotation={270} pcbX={11.700000} pcbY={-0.2} schX={10} schY={-3.8} schOrientation="vertical" connections={{ pin1: "net.X32_N", pin2: "net.GND" }} />
    ...
    <BMA400
      ...
      noConnect={["NC1", "NC2"]}
    />
    <capacitor name="C22" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="io" pcbX={-3} pcbY={-5.5} schX={-2.5} schY={4.5} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />
    <capacitor name="C23" capacitance="100nF" maxVoltageRating="16V" footprint="cap0402" manufacturerPartNumber="CL05B104KO5NNNC" supplierPartNumbers={{ jlcpcb: ["C1525"] }} schSheetName="io" pcbX={1.3} pcbY={-6.8} schX={-9.5} schY={2.5} schOrientation="vertical" connections={{ pin1: "net.VCORE", pin2: "net.GND" }} />
    ...
    />
    <resistor name="R14" resistance="1M" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1004TCE" supplierPartNumbers={{ jlcpcb: ["C26083"] }} schSheetName="io" pcbX={8.4} pcbY={-9} schX={-0.5} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.OLED_EN", pin2: "net.GND" }} />
    <capacitor name="C24" capacitance="1nF" maxVoltageRating="50V" footprint="cap0402" manufacturerPartNumber="0402B102K500NT" supplierPartNumbers={{ jlcpcb: ["C1523"] }} schSheetName="io" pcbX={12} pcbY={-10.2} schX={3.5} schY={0.5} schOrientation="vertical" connections={{ pin1: "net.OLED_CT", pin2: "net.GND" }} />
    <capacitor name="C25" capacitance="1uF" maxVoltageRating="25V" footprint="cap0402" manufacturerPartNumber="CL05A105KA5NQNC" supplierPartNumbers={{ jlcpcb: ["C52923"] }} schSheetName="io" pcbX={13.4} pcbY={-4.2} schX={5.5} schY={3} schOrientation="vertical" connections={{ pin1: "net.OLED_VCC", pin2: "net.GND" }} />
    <PZ200V_11_07P
      name="J3"
      schSheetName="io"
      pcbX={13.5}
    ...
    />
    <resistor name="R15" resistance="100k" tolerance="1%" footprint="res0402" manufacturerPartNumber="0402WGF1003TCE" supplierPartNumbers={{ jlcpcb: ["C25741"] }} schSheetName="io" pcbX={15.9} pcbY={-9.8} schX={2} schY={-5} schOrientation="vertical" connections={{ pin1: "net.USER_BUTTON", pin2: "net.VCORE" }} />
