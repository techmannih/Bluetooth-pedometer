...
import React4, { useEffect as useEffect3, useMemo as useMemo2, useReducer as useReducer2, useState as useState4 } from "react";
import {
  InteractiveGraphics,
...
import { useReducer, useRef as useRef2, useEffect as useEffect2, useMemo, useState as useState2 } from "react";
...
var GenericSolverToolbar = ({
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "space-y-2 p-2 border-b", children: [
    /* @__PURE__ */ jsx3("div", { className: "flex items-center", children: /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-2", ref: menuContainerRef, children: [
      /* @__PURE__ */ jsxs3("div", { className: "flex h-9 items-center space-x-1 rounded-md border border-slate-200 bg-white p-1 shadow-sm", children: [
        /* @__PURE__ */ jsxs3("div", { className: "relative", children: [
          ...
          openMenu === "renderer" && /* @__PURE__ */ jsx3("div", { className: "absolute left-0 z-50 mt-1 min-w-[10rem] rounded-md border border-slate-200 bg-white p-1 text-slate-950 shadow-md", children: ["vector", "canvas"].map((option) => /* @__PURE__ */ jsxs3(
            "button",
            {
              type: "button",
              onClick: () => {
              ...
              children: [
                ...
                renderer === option && /* @__PURE__ */ jsx3("span", { className: "ml-auto text-xs text-slate-500", children: "\u2713" })
              ]
            },
            option
          )) })
        ...
        /* @__PURE__ */ jsxs3("div", { className: "relative", children: [
          ...
          openMenu === "debug" && /* @__PURE__ */ jsx3("div", { className: "absolute left-0 z-50 mt-1 min-w-[12rem] rounded-md border border-slate-200 bg-white p-1 text-slate-950 shadow-md", children: /* @__PURE__ */ jsx3(
            "button",
            {
              type: "button",
              onClick: () => {
        ...
        /* @__PURE__ */ jsxs3("div", { className: "relative", children: [
          ...
          openMenu === "animation" && /* @__PURE__ */ jsx3("div", { className: "absolute left-0 z-50 mt-1 min-w-[12rem] rounded-md border border-slate-200 bg-white p-1 text-slate-950 shadow-md", children: animationSpeedOptions.map((option) => /* @__PURE__ */ jsxs3(
            "button",
            {
              type: "button",
              onClick: () => {
              ...
              children: [
                option.label,
                /* @__PURE__ */ jsx3("span", { className: "ml-auto text-xs text-slate-500", children: option.description }),
                animationSpeed === option.value && /* @__PURE__ */ jsx3("span", { className: "ml-2 text-xs text-slate-500", children: "\u2713" })
              ]
            },
            option.value
          )) })
      ...
      /* @__PURE__ */ jsx3(SolverBreadcrumbInputDownloader, { solver })
    ] }) }),
...
var getStageStatus = (solver, stepIndex, stepName) => {
...
var getStageInfo = (solver, stageIndex) => {
...
var StatusBadge = ({ status }) => {
  ...
  return /* @__PURE__ */ jsx4("span", { className: `font-medium ${colors[status]}`, children: status });
};
var ProgressBar = ({ progress }) => {
  if (progress === 0) return null;
  const percentage = Math.round(progress * 100);
  return /* @__PURE__ */ jsxs4("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsx4("div", { className: "w-20 h-2 bg-gray-200 rounded overflow-hidden", children: /* @__PURE__ */ jsx4(
      "div",
      {
...
var formatStatsLine = (stats) => {
  return Object.entries(stats).map(([key, value]) => `${key}: ${stringifyStatValue(value)}`).join(", ");
};
var StatsCell = ({ stats }) => {
  ...
  return /* @__PURE__ */ jsxs4("details", { className: "cursor-pointer", children: [
    /* @__PURE__ */ jsx4("summary", { className: "whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px]", children: summaryText }),
    /* @__PURE__ */ jsx4("div", { className: "mt-1 text-xs", children: entries.map(([key, value]) => /* @__PURE__ */ jsxs4("div", { children: [
      key,
      ": ",
      stringifyStatValue(value)
    ] }, key)) })
  ] });
};
...
var ChevronIcon = ({ expanded }) => /* @__PURE__ */ jsx4(
  "svg",
  {
...
var PipelineStagesTable = ({
  ...
  const [expandedStages, setExpandedStages] = useState3(/* @__PURE__ */ new Set());
  const stages = solver.pipelineDef.map(
    (_, index) => getStageInfo(solver, index)
  );
  ...
  return /* @__PURE__ */ jsxs4("div", { className: isNested ? "" : "border-t border-gray-200", children: [
    !isNested && /* @__PURE__ */ jsxs4("div", { className: "px-4 py-2 bg-gray-50 border-b border-gray-200 flex items-center justify-between", children: [
      /* @__PURE__ */ jsx4("h3", { className: "text-sm font-semibold text-gray-700", children: "Pipeline Stages" }),
    ...
    /* @__PURE__ */ jsx4("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs4("table", { className: "w-full text-sm", children: [
      !isNested && /* @__PURE__ */ jsx4("thead", { children: /* @__PURE__ */ jsxs4("tr", { className: "bg-gray-50 border-b border-gray-200", children: [
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Stage" }),
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Status" }),
        /* @__PURE__ */ jsxs4("th", { className: "px-4 py-2 text-center font-semibold text-gray-700", children: [
          "i",
          /* @__PURE__ */ jsx4("sub", { children: "0" })
        ] }),
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Iterations" }),
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Progress" }),
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Time" }),
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Stats" }),
        /* @__PURE__ */ jsx4("th", { className: "px-4 py-2 text-left font-semibold text-gray-700", children: "Input" })
      ] }) }),
      /* @__PURE__ */ jsx4("tbody", { children: stages.map((stage) => {
        ...
        return /* @__PURE__ */ jsxs4(React2.Fragment, { children: [
          /* @__PURE__ */ jsxs4(
            "tr",
            {
              ...
              children: [
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2", children: /* @__PURE__ */ jsxs4(
                  "div",
                  {
                    className: "flex items-center gap-2",
                    style: { paddingLeft: indentPadding },
                    children: [
                      isPipeline ? /* @__PURE__ */ jsx4(
                        "button",
                        {
                          onClick: () => toggleExpanded(stage.name),
                          className: "text-gray-500 hover:text-gray-700",
                          title: isExpanded ? "Collapse" : "Expand",
                          children: /* @__PURE__ */ jsx4(ChevronIcon, { expanded: isExpanded })
                        }
                      ) : /* @__PURE__ */ jsx4("span", { className: "w-4" }),
                      /* @__PURE__ */ jsx4("span", { className: "text-gray-400 w-6", children: String(stage.index + 1).padStart(2, "0") }),
                      /* @__PURE__ */ jsx4(
                        "button",
                        {
                      ...
                      /* @__PURE__ */ jsx4("span", { className: "font-medium text-gray-900", children: stage.name })
                    ]
                  }
                ) }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2", children: /* @__PURE__ */ jsx4(StatusBadge, { status: stage.status }) }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2 text-center text-gray-600", children: stage.firstIteration !== null ? stage.firstIteration : "" }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2 text-gray-600", children: stage.iterations }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2", children: /* @__PURE__ */ jsx4(ProgressBar, { progress: stage.progress }) }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2 text-gray-600", children: formatTime(stage.timeSpent) }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2 text-gray-500", children: /* @__PURE__ */ jsx4(StatsCell, { stats: stage.stats }) }),
                /* @__PURE__ */ jsx4("td", { className: "px-4 py-2", children: stage.solverInstance ? /* @__PURE__ */ jsxs4(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx4("span", { children: "Input" })
                    ]
                  }
                ) : null })
              ]
          ...
          isPipeline && isExpanded && /* @__PURE__ */ jsx4("tr", { children: /* @__PURE__ */ jsx4("td", { colSpan: 8, className: "p-0", children: /* @__PURE__ */ jsx4(
            PipelineStagesTable,
            {
...
var GenericSolverDebugger = ({
  ...
  const [renderer, setRenderer] = useState4(() => {
  ...
  const [currentAnimationSpeed, setCurrentAnimationSpeed] = useState4(animationSpeed);
  const visualization = useMemo2(() => {
    try {
  ...
  const graphicsAreEmpty = useMemo2(
  ...
  const isPipelineSolver2 = solver.pipelineDef !== void 0;
  ...
  return /* @__PURE__ */ jsxs6("div", { children: [
    ...
    graphicsAreEmpty ? /* @__PURE__ */ jsx6("div", { className: "p-4 text-gray-500", children: "No Graphics Yet" }) : /* @__PURE__ */ jsx6(
      ErrorBoundary,
      {
        fallback: /* @__PURE__ */ jsx6(SimpleGraphicsSVG, { graphics: visualization }),
        children: renderer === "canvas" ? /* @__PURE__ */ jsx6(InteractiveGraphicsCanvas, { graphics: visualization }) : /* @__PURE__ */ jsx6(InteractiveGraphics, { graphics: visualization })
      }
    ),
    isPipelineSolver2 && /* @__PURE__ */ jsx6(
      PipelineStagesTable,
      {
        solver,
