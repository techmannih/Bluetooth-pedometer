...
declare class PortPointPathingSolver extends BaseSolver {
    ...
    currentConnection: ConnectionPathResult | null;
     ...
     */
    getConnectionsInNode(nodeId: CapacityMeshNodeId, excludeConnectionName?: string): ConnectionPathResult[];
    /**
     * Compute the pf and crossing count of a node with a specific connection removed (for test-ripping).
     */
    computeNodePfWithoutConnection(node: InputNodeWithPortPoints, connectionNameToRemove: string): {
        pf: number;
...
declare class PortfolioSingleIntraNodeSolver extends HyperParameterSupervisorSolver<IntraNodeRouteSolver | TwoCrossingRoutesHighDensitySolver | SingleTransitionCrossingRouteSolver | SingleTransitionIntraNodeSolver | SingleTransitionThroughObstacleIntraNodeSolver | SingleLayerNoDifferentRootIntersectionsIntraNodeSolver | HighDensitySolverA03> {
    ...
    private getNodeSegmentCount;
    private getCandidateProgress;
    private getTotalCandidateWork;
    private getDynamicExpansionWorkBudget;
...
type PortfolioSingleIntraNodeSolverParams = ConstructorParameters<typeof PortfolioSingleIntraNodeSolver>[0];
type GrowShrinkHighDensityIntraNodeSolverParams = PortfolioSingleIntraNodeSolverParams & {
...
declare class GrowShrinkHighDensityIntraNodeSolver extends BaseSolver {
    ...
    activeSubSolver: PortfolioSingleIntraNodeSolver | null;
    ...
    getConstructorParams(): GrowShrinkHighDensityIntraNodeSolverParams;
...
type HighDensityIntraNodeSolver = IntraNodeRouteSolver | PortfolioSingleIntraNodeSolver | GrowShrinkHighDensityIntraNodeSolver;
declare class HighDensitySolver extends BaseSolver {
    ...
    constructor({ nodePortPoints, colorMap, connMap, viaDiameter, traceWidth, obstacleMargin, effort, nodePfById, obstacles, layerCount, useGrowShrinkHighDensityIntraNodeSolver, preserveTerminalPcbPortIds, growShrinkMaxInnerIterationsPerGrowthAttempt, growShrinkFallbackToInvalidGeometryOnFailure, }: {
...
declare class NodeDimensionSubdivisionSolver extends BaseSolver {
...
declare class Pipeline4HighDensityRepairSolver extends BaseSolver {
    readonly repairMargin: number;
    readonly sampleEntries: RepairSampleEntry[];
    readonly originalHdRoutes: HighDensityRoute$1[];
    ...
    getConstructorParams(): readonly [{
        ...
        readonly hdRoutes: HighDensityIntraNodeRoute$1[];
...
declare class Pipeline9RegionalFallbackSolver extends BaseSolver {
 ...
 */
declare class Pipeline9HighDensitySolver extends BaseSolver {
    ...
    readonly routes: HighDensityIntraNodeRoute$1[];
    ...
    activeFallbackFixedRouteSections: Map<string, FixedRouteSection>;
    activeB01Error: string | null;
    activeNode: NodeWithPortPoints | null;
...
type Pipeline9JointDrcRepairSolverParams = {
    ...
    newHdRoutes: HighDensityRoute$1[];
 ...
 */
declare class Pipeline9JointDrcRepairSolver extends BaseSolver {
    readonly params: Pipeline9JointDrcRepairSolverParams;
    readonly inputNewHdRoutes: HighDensityRoute$1[];
...
declare const getRerouteSimpleRouteJson: (simpleRouteJson: SimpleRouteJson, region: RerouteRectRegion) => SimpleRouteJson;
declare const reconnectReroutedSimpleRouteJsonRegion: (originalSrj: SimpleRouteJson, reroutedSrj: SimpleRouteJson) => SimpleRouteJson;
 ...
 */
declare const HyperSingleIntraNodeSolver: typeof PortfolioSingleIntraNodeSolver;
/**
 * @deprecated Use `PortfolioSingleIntraNodeSolver` instead.
 */
