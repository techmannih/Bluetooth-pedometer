...
function getGraphicsFilteredByStep(graphics, {
  ...
  const filteredGraphics = {
    ...
    arrows: graphics.arrows?.filter(
      (a) => a.step === void 0 || a.step === selectedStep
    )
  };
