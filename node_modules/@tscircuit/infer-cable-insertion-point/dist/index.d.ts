...
type CableInsertSide = PlanarCableInsertSide | "above" | "below";
interface CableInsertCenter {
    x: number;
    y: number;
    side: CableInsertSide;
    pcbComponentId?: string;
}
declare const guessCableInsertCenter: (circuitJson: AnyCircuitElement[]) => CableInsertCenter;
declare const addCableInsertNoteRect: (circuitJson: AnyCircuitElement[], opts?: {
    noteWidth?: number;
    noteHeight?: number;
    idPrefix?: string;
}) => {
    guess: CableInsertCenter;
    noteRect: {
        type: "pcb_note_rect";
...
export { type CableInsertCenter, type CableInsertSide, addCableInsertNoteRect, guessCableInsertCenter };
