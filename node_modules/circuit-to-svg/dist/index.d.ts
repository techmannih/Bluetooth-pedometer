import { LayerRef, AnyCircuitElement, PcbPort, SimulationAnalysisResult, SimulationCurrentProbe, SimulationExperiment, SimulationOscilloscopeTrace, SimulationTransientCurrentGraph, SimulationTransientVoltageGraph, SimulationVoltageProbe, SchematicComponent } from 'circuit-json';
export { SimulationAnalysisResult } from 'circuit-json';
...
interface StackedSchematicSheetsSvgOptions extends SchematicSvgOptions {
 ...
 * renderer.
 */
declare function convertCircuitJsonToStackedSchematicSheetsSvg(circuitJson: AnyCircuitElement[], options?: StackedSchematicSheetsSvgOptions): string;

type AcSweepView = "magnitude" | "phase";

type CircuitJsonWithSimulation = AnyCircuitElement;

declare function isSimulationAnalysisResult(circuitElement: Pick<AnyCircuitElement, "type">): circuitElement is SimulationAnalysisResult;
declare function isSimulationTransientCurrentGraph(value: CircuitJsonWithSimulation): value is SimulationTransientCurrentGraph;
...
declare function isSimulationCurrentProbe(value: CircuitJsonWithSimulation): value is SimulationCurrentProbe;
declare function isSimulationOscilloscopeTrace(value: CircuitJsonWithSimulation): value is SimulationOscilloscopeTrace;
...
declare function convertCircuitJsonToSchematicSimulationSvg({ circuitJson, simulation_experiment_id, simulation_transient_current_graph_ids, simulation_transient_voltage_graph_ids, simulation_result_ids, ac_sweep_view, width, height, schematicHeightRatio, schematicOptions, includeVersion, graphAboveSchematic, showErrorsInTextOverlay, }: ConvertSchematicSimulationParams): string;
...
declare function convertCircuitJsonToSimulationGraphSvg({ circuitJson, simulation_experiment_id, simulation_transient_current_graph_ids, simulation_transient_voltage_graph_ids, simulation_result_ids, ac_sweep_view, width, height, includeVersion, }: ConvertSimulationGraphParams): string;
...
export { type AcSweepView, type AssemblySvgContext, CIRCUIT_TO_SVG_VERSION, type CircuitJsonWithSimulation, type ColorMap, type ColorOverrides, type PcbColorMap, type PcbColorOverrides, type PcbContext, type PcbSvgOptions, type PinoutLabel, type PinoutSvgContext, type StackedSchematicSheetsSvgOptions, circuitJsonToPcbSvg, circuitJsonToSchematicSvg, colorMap, convertCircuitJsonToAssemblySvg, convertCircuitJsonToPcbSvg, convertCircuitJsonToPinoutSvg, convertCircuitJsonToSchematicSimulationSvg, convertCircuitJsonToSchematicSvg, convertCircuitJsonToSimulationGraphSvg, convertCircuitJsonToSolderPasteMask, convertCircuitJsonToStackedSchematicSheetsSvg, createErrorTextOverlay, createSvgObjectsForSchComponentPortHovers, getSoftwareUsedString, isSimulationAnalysisResult, isSimulationCurrentProbe, isSimulationExperiment, isSimulationOscilloscopeTrace, isSimulationTransientCurrentGraph, isSimulationTransientVoltageGraph, isSimulationVoltageProbe };
